...
* Bindless rendering using buffer references (`VK_KHR_buffer_device_address`)
...
### Notes
* `eDeferredMemoryAllocation` can crash the app when apps like RiverTuner are running in the back (deactivated, see line \#107)
